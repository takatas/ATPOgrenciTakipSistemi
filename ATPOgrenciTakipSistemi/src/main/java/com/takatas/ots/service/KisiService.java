...
public class KisiService {
	...
	public boolean save(Kisi entity) throws Exception {
		...
		if (entity.getTc() == null) {
			throw new HRException("TC Kimlik No Boþ Olmamalýdýr");
		}
		if(entity.getTc().toString().length() < 11){
			throw new HRException("TC Kimlik No 11 Karakterden Az Olamaz");
		}
